...
public class VaultRequestDataTests
{
    ...
    private static readonly VaultRequest _data = new(Name, Version, Service, Command, Namespace);
    ...
    public void ConstructorShould_Construct_WhenNameIsValid(string name)
        => _ = new VaultRequest(name, Version, Service, Command, Namespace);
    ...
    public void ConstructorShould_ThrowException_WhenNameIsInvalid(string name)
        => Assert.Throws<ValidationException>(() => new VaultRequest(name, Version, Service, Command, Namespace));
    ...
    {
        // Arrange
        VaultRequest data = new(Name, Version, Service, string.Empty, Namespace);
